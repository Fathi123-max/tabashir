# Tabashir Web Application - QWEN.md

## Project Overview

Tabashir HR Consulting is a comprehensive HR platform built with Next.js, Prisma, and PostgreSQL. It serves three main user types: candidates, recruiters, and administrators, providing job matching, resume optimization, and career services with AI-powered features.
...
### Authentication Flow
```
User Registration -> Provider Type Check
  -> Google: Auto-verify Email
  -> Credentials: Send Verification Email
      -> User Clicks Link
        -> Email Verified
  -> User Can Login
    -> User Type Check
